...
void IMU_sensor::printIMUInfo(){
    ...
    Serial.print(acceptedRangeHighBound);
    Serial.print(" , ");
    Serial.println(acceptedRangeLowBound);
    delay(1000);    
}

float IMU_sensor::getAcceptedRangeHighBound(){
    ...
    acceptedRangeHighBound = heading + offset;
}

float IMU_sensor::getAcceptedRangeLowBound(){
    heading = iPsi / 100.0f;
    if(heading < 0){
        heading = heading + 360;
    }

    acceptedRangeLowBound = heading - offset;

    if(acceptedRangeLowBound < 0){
        acceptedRangeLowBound = heading + 360;
    }
    }
    
void IMU_sensor::iecompass(int16_t iBpx, int16_t iBpy, int16_t iBpz, int16_t iGpx, int16_t iGpy, int16_t iGpz)
{
    /* stack variables */
    ...
    */
    ...
    int16_t IMU_sensor::iTrig(int16_t ix, int16_t iy)
    {
    ...
    int16_t IMU_sensor::iHundredAtan2Deg(int16_t iy, int16_t ix)
    {
    ...
    int16_t IMU_sensor::iHundredAtanDeg(int16_t iy, int16_t ix)
    {
    ...
    int16_t IMU_sensor::iDivide(int16_t iy, int16_t ix)
    {
